...
if (Meteor.isServer) {
    ...
    Meteor.startup(function() {
        ...
        createPost("zano_drone", moment().toDate(), "yoohenry", "ZANO-Nano-Drone.jpg", "Autonomous, Intelligent, Developable. Meet ZANO the world's most sophisticated nano drone - aerial photo and HD video capture platform.", 967, "http://www.flyzano.com");
